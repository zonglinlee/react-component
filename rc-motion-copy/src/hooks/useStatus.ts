...
export default function useStatus(
  ...
  // 绑定 animationend transitionend 事件监听
  ...
  // startStep调用之后将会从 STEP_PREPARE 步骤开始进行 animation 或者 transition
  // 按照这个顺序进行 [STEP_PREPARE, STEP_START, STEP_ACTIVE, STEP_ACTIVATED]
  ...
  useIsomorphicLayoutEffect(() => {
    ...
    // MotionStatus: STATUS_NONE STATUS_APPEAR STATUS_ENTER STATUS_LEAVE
    // Appear
